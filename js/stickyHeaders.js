...
h0.style.top=h0l1.style.top=clamp(hph0.offsetTop-window.pageYOffset,0, window.innerHeight-70)+"px";
h1.style.top=h1l1.style.top=h1l2.style.top=clamp(hph1.offsetTop-window.pageYOffset,0, window.innerHeight-70)+"px";
h2.style.top=h2l2.style.top=h2l3.style.top=clamp(hph2.offsetTop-window.pageYOffset,0, window.innerHeight-70)+"px";
h3.style.top=h3l3.style.top=clamp(hph3.offsetTop-window.pageYOffset,0, window.innerHeight-70)+"px";
